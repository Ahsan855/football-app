...
const About = () => {
  return (
    <div>
      <section class="bg-[#1E1E1E] body-font">
        <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
          ...
          <div class="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
            ...
            <div class="flex justify-center">
              <button class="inline-flex text-black bg-[#CCF300] border-0 py-2 px-6 focus:outline-none hover:bg-[#a7c50f] rounded text-lg">
                Register on Permint
              </button>
              <button class="ml-4 inline-flex text-[#CCF300] hover:text-black border-2 border-[#CCF300] py-2 px-6 hover:bg-[#CCF300] rounded text-lg">
                Linktree
              </button>
            </div>
          </div>
